...
@Component({
  selector: 'app-guide-category-home',
  templateUrl: './guide-category-home.component.html',
  styleUrls: ['./guide-category-home.component.scss']
})
export class GuideCategoryHomeComponent implements OnInit, OnDestroy
{
